...
/*
    싱글톤? 프로그램 전체에서 단 하나의 객체만 만들도록 보장하는 것
    스프링 프레임워크의 서블릿 객체 생성시 사용 됩니다.
 */
public class SingletonMain {
    public static void main(String[] args) {
        //Singleton singleton = new Singleton(); 객체 생성불가
        Singleton singleton1 = Singleton.getSingleton(); // 이미 만들어져 있는 싱글톤 객체의 주소를 담아 옴
